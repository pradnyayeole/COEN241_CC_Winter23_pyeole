...
Ans 2.c.
The ping times are much longer for h1 to h8 than h1 to h2, because h1 only has one switch in between itself and h2,i.e.s3, whereas there are several hops between h1 and h8,i.e., s3,s2,s1,s5,s7.
...
Ans 2.a. h1 ping h2 - Average ping is 2.480 ms
	 h1 ping h8 - Average ping is 3.605 ms


Ans 2.b. h1 ping h2 - Minimum ping observed is 2.004 ms
	 h1 ping h8 - Minimum ping observed is 2.987 ms
	 
	 h1 ping h2 - Maximum ping observed is 3.007 ms
	 h1 ping h8 - Maximum ping observed is 15.973 ms
...
b.
In both the cases, the throughput for task 3 is larger than that for task 2. This is due to lesser network congestion as in task 3, as there will not be flooding of packets after the mac_to_port map has learnt all the ports and the switches will not be burdened much.
